...
BUCKET_NAME="fyp-slide-generator-output" # <-- CHANGE TO YOUR BUCKET NAME

# JOB_NAME: the name of your job running on AI Platform.
JOB_PREFIX="fyp-slide-generator-job"
...
IMAGE_REPO_NAME=fyp_slide_generator_pytorch
...
docker build --no-cache -f Dockerfile -t $CUSTOM_TRAIN_IMAGE_URI ../../trainer
