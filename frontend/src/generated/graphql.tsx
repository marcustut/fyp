...
export type CreateLinkInput = {
  ...
  owner_id: Scalars['ID'];
  visited_count?: InputMaybe<Scalars['Int']>;
};

export type CreateLinkOptionalLinkIdInput = {
...
export type LinkOrder = {
  direction: OrderDirection;
  field?: InputMaybe<LinkOrderField>;
};

export enum LinkOrderField {
  CreatedAt = 'CREATED_AT',
  UpdatedAt = 'UPDATED_AT'
}
...
export type LinkWhereInput = {
  ...
  linkIDContains?: InputMaybe<Scalars['String']>;
  linkIDContainsFold?: InputMaybe<Scalars['String']>;
  linkIDEqualFold?: InputMaybe<Scalars['String']>;
  linkIDGT?: InputMaybe<Scalars['String']>;
  linkIDGTE?: InputMaybe<Scalars['String']>;
  linkIDHasPrefix?: InputMaybe<Scalars['String']>;
  linkIDHasSuffix?: InputMaybe<Scalars['String']>;
  linkIDIn?: InputMaybe<Array<Scalars['String']>>;
  linkIDLT?: InputMaybe<Scalars['String']>;
  linkIDLTE?: InputMaybe<Scalars['String']>;
  linkIDNEQ?: InputMaybe<Scalars['String']>;
  linkIDNotIn?: InputMaybe<Array<Scalars['String']>>;
  not?: InputMaybe<LinkWhereInput>;
  or?: InputMaybe<Array<LinkWhereInput>>;
  /** original_url field predicates */
  originalURL?: InputMaybe<Scalars['String']>;
  originalURLContains?: InputMaybe<Scalars['String']>;
  originalURLContainsFold?: InputMaybe<Scalars['String']>;
  originalURLEqualFold?: InputMaybe<Scalars['String']>;
  originalURLGT?: InputMaybe<Scalars['String']>;
  originalURLGTE?: InputMaybe<Scalars['String']>;
  originalURLHasPrefix?: InputMaybe<Scalars['String']>;
  originalURLHasSuffix?: InputMaybe<Scalars['String']>;
  originalURLIn?: InputMaybe<Array<Scalars['String']>>;
  originalURLLT?: InputMaybe<Scalars['String']>;
  originalURLLTE?: InputMaybe<Scalars['String']>;
  originalURLNEQ?: InputMaybe<Scalars['String']>;
  originalURLNotIn?: InputMaybe<Array<Scalars['String']>>;
  /** updated_at field predicates */
  updatedAt?: InputMaybe<Scalars['Time']>;
  updatedAtGT?: InputMaybe<Scalars['Time']>;
  updatedAtGTE?: InputMaybe<Scalars['Time']>;
  ...
  visitedCount?: InputMaybe<Scalars['Int']>;
  visitedCountGT?: InputMaybe<Scalars['Int']>;
  visitedCountGTE?: InputMaybe<Scalars['Int']>;
  visitedCountIn?: InputMaybe<Array<Scalars['Int']>>;
  visitedCountLT?: InputMaybe<Scalars['Int']>;
  visitedCountLTE?: InputMaybe<Scalars['Int']>;
  visitedCountNEQ?: InputMaybe<Scalars['Int']>;
  visitedCountNotIn?: InputMaybe<Array<Scalars['Int']>>;
};
...
export type MutationCreateLinkOptionalLinkIdArgs = {
...
export type UpdateLinkInput = {
  clear_owner?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  link_id?: InputMaybe<Scalars['String']>;
...
export type UserWhereInput = {
  ...
  hasLinks?: InputMaybe<Scalars['Boolean']>;
  hasLinksWith?: InputMaybe<Array<LinkWhereInput>>;
...
export type ShortenUrlMutationVariables = Exact<{
  input: CreateLinkOptionalLinkIdInput;
}>;


export type ShortenUrlMutation = { __typename?: 'Mutation', CreateLinkOptionalLinkID: { __typename?: 'Link', id: string, link_id: string, original_url: string, visited_count: number, updated_at: any, created_at: any } };

export type LinkFieldsFragment = { __typename?: 'Link', id: string, link_id: string, original_url: string, visited_count: number, updated_at: any, created_at: any };
...
export type CreateSlideMutation = { __typename?: 'Mutation', CreateSlide: { __typename?: 'Slide', id: string, name: string, path_token?: Array<string> | null, size?: number | null, access_level: AccessLevel, shared_with: Array<string>, deleted: boolean, created_at: any, updated_at: any, user: { __typename?: 'User', id: string, username: string, email: string, full_name?: string | null, avatar_url?: string | null, bio?: string | null, created_at: any, updated_at: any }, instance?: { __typename?: 'Instance', id: string, instance_id: string, instance_type: string, private_dns_name: string, private_ip_address: string, public_dns_name: string, public_ip_address: string, image_id: string, architecture: string, availability_zone: string, created_at: any, updated_at: any } | null } };
...
export type UpdateSlideWithTextMutation = { __typename?: 'Mutation', UpdateSlideWithText: { __typename?: 'Slide', id: string, name: string, path_token?: Array<string> | null, size?: number | null, access_level: AccessLevel, shared_with: Array<string>, deleted: boolean, created_at: any, updated_at: any, user: { __typename?: 'User', id: string, username: string, email: string, full_name?: string | null, avatar_url?: string | null, bio?: string | null, created_at: any, updated_at: any }, instance?: { __typename?: 'Instance', id: string, instance_id: string, instance_type: string, private_dns_name: string, private_ip_address: string, public_dns_name: string, public_ip_address: string, image_id: string, architecture: string, availability_zone: string, created_at: any, updated_at: any } | null } };
...
export type UpdateSlideMutation = { __typename?: 'Mutation', UpdateSlide: { __typename?: 'Slide', id: string, name: string, path_token?: Array<string> | null, size?: number | null, access_level: AccessLevel, shared_with: Array<string>, deleted: boolean, created_at: any, updated_at: any, user: { __typename?: 'User', id: string, username: string, email: string, full_name?: string | null, avatar_url?: string | null, bio?: string | null, created_at: any, updated_at: any }, instance?: { __typename?: 'Instance', id: string, instance_id: string, instance_type: string, private_dns_name: string, private_ip_address: string, public_dns_name: string, public_ip_address: string, image_id: string, architecture: string, availability_zone: string, created_at: any, updated_at: any } | null } };
...
export const ShortenUrlDocument = gql`
    mutation ShortenURL($input: CreateLinkOptionalLinkIDInput!) {
  CreateLinkOptionalLinkID(input: $input) {
    ...LinkFields
  }
}
...
export function useShortenUrlMutation() {
  return Urql.useMutation<ShortenUrlMutation, ShortenUrlMutationVariables>(ShortenUrlDocument);
};
